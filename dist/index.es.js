      ...
      return vouchersData.map(function (it, i) {
        ...
        return items.map(function (item, z) {
          return React.createElement(
            ...
            React.createElement('img', { src: item, className: styles.msVoucherCarouselImg, alt: it.title }),
            React.createElement(
              'div',
              {
              ...
              React.createElement('div', { className: styles.msVoucherColSm6 + ' ' + styles.msVoucherCarouselPr }),
              React.createElement(
                'div',
    ...
    value: function imagesVoucherCarousel(vouchersData) {
      ...
      return vouchersData.map(function (it, i) {
        return React.createElement(
          ...
          React.createElement('img', { src: it.imgVoucher, className: styles.msVoucherCarouselImg, alt: it.title }),
          React.createElement(
            'div',
            {
              className: styles.msVoucherRow + ' ' + styles.msVoucherContainer + ' ' + styles.msVoucherCarouselBtn + ' ' + styles.msVoucherPadding0,
...
export default MasspaVoucherCarousel;
